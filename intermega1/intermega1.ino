...
#define print_sonar	1
#define print_comp	1

#define print_just_one	1
#define run_just_one	1



#define print_raw_interupts 0
...
#if print_output
	Serial.print("{Output_right,T, ");	Serial.print(Output_right);	Serial.print("} ");
#if print_just_one != 1
	Serial.print("{Output_front,T, ");	Serial.print(Output_front);	Serial.print("} ");
	Serial.print("{Output_left,T, ");	Serial.print(Output_left);	Serial.print("} ");
	Serial.print("{Output_rear,T, ");	Serial.print(Output_rear);	Serial.print("} ");
#endif
#endif

#if print_input
	Serial.print("{roll_in,T, ");		Serial.print(roll_in);		Serial.print("} ");
#if print_just_one != 1
	Serial.print("{pitch_in,T, ");		Serial.print(pitch_in);		Serial.print("} ");
	Serial.print("{throttle_in,T, ");	Serial.print(throttle_in);	Serial.print("} ");
#endif
#endif

#if print_sonar
	Serial.print("{right_sonar,T, ");	Serial.print(right_sonar);	Serial.print("} ");
#if print_just_one != 1
	Serial.print("{front_sonar,T, ");	Serial.print(front_sonar);	Serial.print("} ");
	Serial.print("{left_sonar,T, ");	Serial.print(left_sonar);	Serial.print("} ");
	Serial.print("{rear_sonar,T, ");	Serial.print(rear_sonar);	Serial.print("} ");
#endif
#endif

	Serial.print("{safe_distance,T, ");	Serial.print(safe_distance);	Serial.print("} ");

#if print_comp
	Serial.print("{compd_roll,T, ");	Serial.print(compd_roll);	Serial.print("} ");
#if print_just_one != 1
	
	Serial.print("{compd_pitch,T, ");	Serial.print(compd_pitch);	Serial.print("} ");
	Serial.print("{compd_throttle,T, ");	Serial.print(compd_throttle);	Serial.print("} ");
#endif
#endif
